...
public class TextPaintActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spTextAlign = (Spinner)findViewById(R.id.spinner);
        intTextAlign();
    ...
    private void intTextAlign() {
        List<String> textAligns = new ArrayList<>();
        textAligns.add("Left");
        textAligns.add("Center");
        textAligns.add("Right");

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item, textAligns);
        adapter.setDropDownViewResource(android.R.layout.simple_list_item_single_choice);
        spTextAlign.setAdapter(adapter);
        spTextAlign.setOnItemSelectedListener(new OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                myFontMetricsView.setTextAlign(align);
            }
